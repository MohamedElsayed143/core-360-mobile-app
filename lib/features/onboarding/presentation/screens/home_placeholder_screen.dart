                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            const Divider(
                                color: Color(0xFF3d4d6b), height: 24),
                            _profileInfoRow(
                                'EMAIL ADDRESS',
                                user.email ?? 'Not set'),
                            const Divider(
                            ...
                            Expanded(
                                child: FutureBuilder<int>(
                                  ...
                                  builder: (context, snapshot) {
                                    return _profileStatBox(
                                        'WORKOUTS', '${snapshot.data ?? 0}');
                                  },
                                )),
                            const SizedBox(width: 10),
                            Expanded(
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Expanded(
                                child:
                                    _profileStatBox('ALERTS', '0')),
                            const SizedBox(width: 10),
                            Expanded(
                                child:
                                    _profileStatBox('PROGRESS', '0')),
                            const SizedBox(width: 10),
  ...
  Widget _profileStatBox(String label, String value) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border:
            Border.all(color: const Color(0xFF3d4d6b), width: 0.5),
      ),
      child: Column(
        children: [
          Text(
